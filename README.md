<!-- Badges / Banner -->
<p align="center">
  <img src="https://img.shields.io/badge/Android-App-4F8DF7?style=for-the-badge" alt="Android">
  <img src="https://img.shields.io/badge/Kotlin-✓-4F8DF7?style=for-the-badge" alt="Kotlin">
  <img src="https://img.shields.io/badge/Jetpack%20Compose-✓-4F8DF7?style=for-the-badge" alt="Compose">
  <img src="https://img.shields.io/badge/Firebase-Chat-4F8DF7?style=for-the-badge" alt="Firebase">
</p>

<h1 align="center">🎧 📱 PlayList Maker — мультимедиа приложение</h1>

<p align="center">
  <b>Цвет интерфейса:</b> мягкий синий (#4F8DF7) ·
  <b>Стиль баннера:</b> 2 (светлый)
</p>
...
<strong>Гибридный стек</strong>: Jetpack Compose + Fragments/Activities + многоэкранная навигация + кастомные анимации + работа с API + Firebase.
<hr/>
...
- При импорте 🎵 трека или 🎶 треков поддерживается как вертикальный так и горизонтальный скролл<br> 
  ...
  <tr>
    ...
    <td width="530" valign="middle" align="left">
      <p>
       ...
       <td width="530" valign="middle" align="left">
      <p>
        - Альтернативное бесплатная авто-поиск видео режима песен с тулбара + при отсутствии видео полное звуковая поддержка, при видео авто полно-экранное на ландскейпе, time bar для прокрутки назад-вперед<br>   
      </p>
     </td>
    <td width="160" align="center" valign="middle">
