...
interface IMDbApiService {
    ...
    suspend fun searchNames(@Path("expression", encoded = true) expression: String): NamesSearchResponse

    @GET("/en/API/SearchMovie/k_zcuw1ytf/{expression}")
    suspend fun searchMovies(@Path("expression", encoded = true) expression: String): MoviesSearchResponse
